...
**Examples from "the cat sat on the mat"**:
...
**Insight**: As n increases, coverage drops exponentially!
...
**Problem with Add-One**: Too much probability to unseen events.
...
# Example (conceptual - needs edit distance library)
...
```
Sentence: "The movie was not very good but the acting was brilliant."
...
- Progress to [Embeddings](../embeddings/) to see how neural models represent words
- Study [Language Models](../language_models/) to understand modern neural language modeling
